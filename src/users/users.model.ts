...
export class User extends Model<User, UserAttributes> {
  ...
  @ApiProperty({example: 'Example!', description: 'A password that contains at least one special character, one capital letter, and is at least 6 characters long.'})
  @Column({
  ...
  @ApiProperty({example: 'Insulting participants', description: 'Reason for blocking'})
  @Column({
